...
const statusStyles = {
  ...
  APPROVEED: "bg-green-100 text-green-600",
...
export const DoctorAppointments = () => {
  ...
  const handleStatus = async (appointmentId, status) => {
    ...
    try {
      ...
      dispatch({ type: "UPDATE_ERROR", payload: "Failed to update status." });
    }
  };
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-r from-orange-50 to white">
      <Navbar />
      <Sidebar />
      <div className='ml-64 p-8 space-y-6 border'>
        {/* HEADER */}
        <div>
